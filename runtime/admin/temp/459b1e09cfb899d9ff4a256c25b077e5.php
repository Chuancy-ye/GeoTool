<?php /*a:1:{s:53:"D:\phpstudy_pro\WWW\tp\app\admin\view\index\edit.html";i:1615315766;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<body style="padding:10px;">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="datetime-local" class="layui-input" name="start_time" value="<?php echo htmlentities($shop['start_time']); ?>">
			</div>
		</div>
		<div class="layui-form-item">

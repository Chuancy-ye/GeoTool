<?php /*a:1:{s:52:"D:\phpstudy_pro\WWW\tp\app\user\view\index\uadd.html";i:1615315502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<input type="hidden" name="status" value="1">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 7rem">
            <input class="layui-input" name="title" type="text" value="<?php echo htmlentities($info['name']); ?>">
            </input>
        </div>
